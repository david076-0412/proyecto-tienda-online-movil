...
public class InicioPetAdapter extends FirestoreRecyclerAdapter<Pet,InicioPetAdapter.ViewHolder> {
    private FirebaseFirestore mFirestore = FirebaseFirestore.getInstance();
    private InicioPetAdapter.OnItemClickListener onItemClickListener;
    private int focusedItem = 0;

    public InicioPetAdapter(@NonNull FirestoreRecyclerOptions<Pet> options) {
        super(options);
...
//      format.setMaximumFractionDigits(2);
        ...
        viewHolder.ratingBar.setRating(Pet.getEstrellas());
