...
public class ContactosAdministradorActivity extends AppCompatActivity {
    ...
    String Panel_Cliente,Panel_Repartidor,Panel_Administrador;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contactos_administrador);
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Usuario.equals("Cliente")){
                    ...
                    Intent ic = new Intent(ContactosAdministradorActivity.this, PanelChat_Cliente.class);
                    ...
                    Intent ir = new Intent(ContactosAdministradorActivity.this, PanelChat_RepartidorActivity.class);
                    ...
                    Intent ia = new Intent(ContactosAdministradorActivity.this, PanelChat_Administrador.class);
    ...
    private void setUpRecyclerView() {
        ...
        query = mFirestore.collection("Administrador");
        ...
        mAdapter.setOnItemClickListener(new ContactosAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(ContactosAdministradorActivity.this, Chat_Administrador.class);


                mFirestore.collection("Usuario/Administrador/"+id).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        for (QueryDocumentSnapshot snapshot : task.getResult()){
                            ...
                            //Toast.makeText(ContactosAdministradorActivity.this, nombreadministrador, Toast.LENGTH_SHORT).show();

                            UserDetails.chatWith = nombreadministrador + " " + apellidoadministrador;


                            i.putExtra("name",nombreadministrador);
                            i.putExtra("apellido", apellidoadministrador);
