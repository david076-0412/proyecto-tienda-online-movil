package com.aplication.appgestionrepartos.repartidor_ui.cliente_pedido;
...
public class Clientes_PedidoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_cliente_pedido, container, false);
...
*/
        ...
        mAdapter = new RepartidorAdapter(firestoreRecyclerOptions, getActivity(), getActivity().getSupportFragmentManager());
