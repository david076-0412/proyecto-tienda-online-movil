...
import com.aplication.appgestionrepartos.adapter.PedidoAdapter;
...
public class PedidoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(PedidoActivity.this, InterfazClienteActivity.class));
    ...
    private void setUpRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(new PedidoAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(PedidoActivity.this, ListadoProductosActivity.class);
