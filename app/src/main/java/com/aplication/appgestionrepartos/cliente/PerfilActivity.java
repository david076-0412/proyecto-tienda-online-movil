...
public class PerfilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_regresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PerfilActivity.this, InterfazClienteActivity.class));
        ...
        btn_actualizar = findViewById(R.id.btn_actualizar);
            ...
            btn_actualizar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(namePerfil.isEmpty() && apellidoPerfil.isEmpty() && dniPerfil.isEmpty() && direccionPerfil.isEmpty() && emailPerfil.isEmpty() && celularPerfil.isEmpty() && passwordPerfil.isEmpty()){
                        ...
                        if (dni.length() == 8 && tarjeta.length()==21) {



                            if (tarjeta.length()==21){
                            ...
                            }else if (tarjeta.length()<22){

                                tarjeta.setError("Llenar el campo con 21 numeros exactos");
                        ...
                        }else if (dni.length() <= 7 && tarjeta.length()<=20){
            ...
            btn_restaurar_contrasena.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder dialogo2 = new AlertDialog.Builder(PerfilActivity.this);
                        ...
                        public void onClick(DialogInterface dialogo2, int id) {
                            ...
                            mAuth.sendPasswordResetEmail(emailPerfil).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(PerfilActivity.this, "Reset Link Sent To Your Email.", Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(PerfilActivity.this, "Error! Reset Link is Not Sent"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
    ...
    public void tarjeta_credito_sheet(View view){
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(
                PerfilActivity.this,R.style.BottomSheetDialogTheme
        );
        View bottomSheetView = LayoutInflater.from(PerfilActivity.this)
                .inflate(
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                for (QueryDocumentSnapshot snapshot1 : task.getResult()){
                    ...
                    reference.putFile(image_url).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            if (uriTask.isSuccessful()){
                                uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        mFirestore.collection("Cliente").document(idUser).update(map);
                                        mFirestore.collection("pago").document(idUser).update(map);
                                        mFirestore.collection("Usuario/Cliente/"+idUser).document("registro").update(map);
                        ...
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PerfilActivity.this, "Error al cargar foto", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    public void updatePerfil(String namePerfil, String apellidoPerfil, String dniPerfil, String direccionPerfil, String emailPerfil, String celularPerfil, String passwordPerfil, String id, String tarjetaPerfil){
                ...
                usuario1.updateEmail(emailPerfil).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            DocumentReference reference = mFirestore.collection("Cliente").document(idUser);
                            ...
                            DocumentReference reference1 = mFirestore.collection("Usuario/Cliente/"+idUser).document("registro");
        ...
        mFirestore.collection("Usuario/Cliente/"+idUser).document("registro").update(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(getApplicationContext(), "Cliente actualizado", Toast.LENGTH_SHORT).show();
                finish();
